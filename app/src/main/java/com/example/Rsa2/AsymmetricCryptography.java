...
//		this.cipher.init(Cipher.ENCRYPT_MODE, key);
//		return Base64.Base64String(cipher.doFinal(msg.getBytes("UTF-8")));
//	}
//
...
//
//		final String strEnkrip = "Text Enkrip";
//		final String strDekrip = "Text dekrip";
//
//		String msg = "Cryptography is fun!";
//		String encrypted_msg = ac.encryptText(strEnkrip, privateKey);

...
implements Preference.OnPreferenceChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_server_settings_key)));
		bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_timer_settings_key)));
